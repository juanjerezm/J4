...
This document only applies to Denmark

## Assumptions

- Fuel costs include the fuel price, carbon and energy taxes, CO2-quota price, and electricity tariffs (the latter for consumers and not generators).
