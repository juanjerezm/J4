...
* Control flags
* ======================================================================
$setglobal  name            DH_only
$setglobal  path_output     ../../results/%name%.gdx
...
/
$onDelim
* $ifi %EHR% == YES $include    '../../data/dh-generator-data/dh-generator-names.csv'
* $ifi %EHR% == NO  $include    '../../data/dh-generator-data/dh_HR-generator-names.csv'
$include    '../../data/dh-generator-data/dh-generator-names.csv'
$offDelim
/;
...
/
$onDelim
$include    '../../data/dh-generator-data/dh-generator-fuels.csv'
$offDelim
/;
...
$onDelim
$include    '../../data/dh-generator-data/dh-generator-data.csv'
$offDelim
;
...
C_h(G)$(G_HO(G) OR G_HR(G))     = GNRT_DATA(G,'VOM_h');
...
* PARAMETER C_ff(T,F)             'Cost of fuel consumption (EUR/MWh)';
* C_ff(T,F)                       = pi_f(T,F) + q_f(T,F)*pi_co2(F);
...
eq_ramping_up(T,G)..                        x_f(T++1,G) - x_f(T,G)  =l= R_f(G)*Y_f(G);
eq_ramping_down(T,G)..                      x_f(T,G) - x_f(T++1,G)  =l= R_f(G)*Y_f(G);
