...
* PROBLEMS:
* X_hr in DH equations (in heat balance)
* DH units in cold balance
* eq_conversion_CO includes DH units as well
* 
...
eq_obj_DH..                                    obj('DH')            =e= + sum((T,G_DH),  C_f(T,G_DH)    *x_f_dh(T,G_DH)) 
                                                                        ...
                                                                        + sum((T,G_HR), lambda_h(T) *x_hr(T,G_HR))
                                                                        ;
...
eq_heat_balance(T)..                        sum(G_DH, x_h(T,G_DH)) + sum(G_WH, x_hr(T,G_WH))       =e= D_h(t);
