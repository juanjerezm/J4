...
class ScenarioParams:
    ...
    def process_data(self) -> None:
        ...
        df = utils.aggregate(df, ["case"], ["level"])
...
def main(param_files):
    ...
    ax.set_ylabel('Heat recovery production [MWh]')
    ax.set_title('Sensitivity of production vs discount rate')
